...
function single(){
    ...
    return new Promise(function(resolve,reject){
        let sql="SELECT  DISTINCT b.good_id,b.color,b.material,b.style,b.good_name,b.occasion,b.price ,a.img_url,b.size,d.number FROM gimage AS a,good AS b,suit_good AS c ,(SELECT good_id,COUNT(1) AS number FROM order_det GROUP BY good_id) AS d WHERE a.img_id = b.img_id   AND b.good_id = d.good_id AND b.good_id=3";
...
//套装数量
function singleNum(goodId,evaId,number){
    "use strict";
    console.log(number);
    return new Promise(function (resolve,reject) {
...
function evaList(){
    "use strict";
    return new Promise(function(resolve,reject){
        let sql="SELECT evaluate_text,evaluate_img FROM evaluate WHERE good_id=2";
        let sql1="SELECT COUNT(1) AS num FROM evaluate WHERE good_id=2 GROUP BY good_id";
        let a,b;
        pool.query(sql,[]).then(function(data){
            console.log(data);
            a=data;
